...
- [docker-intro.zip](https://carpentries-incubator.github.io/docker-introduction/files/docker-intro.zip)をダウンロードして、拡張して、デスクトップに置く
...
基本レッスン: unix, git, python, R

![](images/swc-core-lessons.png)

## レッスン Lessons

追加レッスン: make, MATLAB, SQL, Docker
